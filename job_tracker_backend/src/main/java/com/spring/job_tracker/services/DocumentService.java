...
public class DocumentService {
    ...
    public DocumentService(DocumentRepository documentRepository, DocumentHelper documentHelper, FileHelper fileHelper) {
    ...
    public Resource downloadDocument(String fileKey) throws IOException {
        Document document = documentRepository.findByFileKey(fileKey)
