...
public class JobApplicationService {
    ...
    public JobApplicationService(JobApplicationRepository jobApplicationRepository, CompanyRepository companyRepository, JobApplicationHelper jobApplicationHelper, CompanyHelper companyHelper, JobStatusRepository jobStatusRepository) {
